                                ...
                                {products.data.map((product) => (
                                    <div key={product.id} className="group relative bg-white border border-gray-100 rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                        <div className="w-full h-64 bg-gray-200 aspect-w-1 aspect-h-1 overflow-hidden group-hover:opacity-90">
                                            ...
                                            <button
                                                onClick={() => {
                                                    router.post(route('wishlist.store'), { product_id: product.id }, {
                                                        preserveScroll: true,
                                                    });
                                                }}
                                                className="absolute top-2 right-2 p-2 bg-white rounded-full shadow hover:bg-red-50 text-gray-400 hover:text-red-500 transition opacity-0 group-hover:opacity-100 focus:opacity-100"
